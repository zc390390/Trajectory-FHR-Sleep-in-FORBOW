...
<<<<<<< HEAD:RMD Files/SRI Analysis.Rmd
...
linear <- lmer(SRI2_scaled ~ fhr*age  + sex +
                 (1 | fid/subject_id/filename), data = merged, REML = FALSE)
linear_poly <- lmer(SRI2_scaled ~ fhr*age + (age2) + sex +
                    (1 | fid/subject_id/filename), data = merged, REML = FALSE)
anova(linear, linear_poly)
summary(linear_poly)
>>>>>>> a14b72a8c6c3eeb5682c42f968e52441544898cc:SRI Analysis.Rmd
